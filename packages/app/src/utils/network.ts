import { localhost as _localhost, arbitrum, arbitrumSepolia } from '@reown/appkit/networks'

export const localhost = { ..._localhost, id: 639 }

export const ETH_CHAINS = [localhost, arbitrum, arbitrumSepolia]
